...
export async function optimizeRoute(
    ...
    try {
        // OSRM Public API limits requests to 100 coordinates.
        // We limit points to max 90 to ensure we don't hit the limit.
        const limitedPoints = points.slice(0, 90);
        const allPoints = [start, ...limitedPoints];
