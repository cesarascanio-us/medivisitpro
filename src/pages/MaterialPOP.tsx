...
import { POPResourceRequests } from "@/components/pop/POPResourceRequests";
        ...
        <div className="space-y-6">
            ...
            <Tabs defaultValue="pending" className="w-full">
                <EliteTabsList className="mb-6">
                    ...
                    <EliteTabsTrigger value="requests" label="Solicitudes" icon={Send} />
                    {canManageCatalog && (
                        <EliteTabsTrigger value="catalog" label="Catálogo" icon={Package} />
                    )}
                    {canManageAssignments && (
                        <EliteTabsTrigger value="assign" label="Asignar Fijo" icon={Archive} />
                    )}
