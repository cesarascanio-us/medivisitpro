                ...
                statusColor="bg-emerald-500"
                 rightContent={
                    <div className="flex flex-wrap items-center gap-2 md:gap-3 justify-end">
                        <Button variant="outline" onClick={() => exportToCSV(pharmacies, 'farmacias')} className="bg-muted/10 border-border/40 rounded-2xl h-12 lg:h-14 px-4 lg:px-8 font-black uppercase tracking-widest text-[10px] shadow-inner hover:bg-muted/20 transition-all flex items-center justify-center">
                            <Download className="h-4 w-4 text-primary lg:mr-3" />
                            <span className="hidden lg:inline">Exportar Inteligencia</span>
                        </Button>
                        <ImportDialog
                            ...
                            className="bg-muted/10 border-border/40 rounded-2xl h-12 lg:h-14 px-4 lg:px-8 font-black uppercase tracking-widest text-[10px] shadow-inner hover:bg-muted/20 transition-all text-foreground flex items-center justify-center"
                        ...
                        }} className="bg-muted/10 border-border/40 rounded-2xl h-12 lg:h-14 px-4 lg:px-8 font-black uppercase tracking-widest text-[10px] shadow-inner hover:bg-muted/20 transition-all flex items-center justify-center">
                            <RefreshCw className={cn("h-4 w-4 text-primary lg:mr-3", loading && "animate-spin")} />
                        ...
                        }} className="rounded-2xl h-12 lg:h-14 px-4 lg:px-8 font-black uppercase tracking-widest text-[10px] shadow-inner flex items-center justify-center">
                            <Trash2 className="h-4 w-4 lg:mr-3 text-white" />
                            <span className="hidden lg:inline">Vaciar Todo</span>
                        </Button>
                        <Button
                            onClick={() => {
                            ...
                            className="bg-primary hover:bg-primary/90 text-white rounded-2xl h-12 lg:h-14 px-5 lg:px-10 font-black uppercase tracking-widest text-[10px] shadow-premium-md transition-all active:scale-95 flex items-center gap-2 lg:gap-3 justify-center"
                        >
                            <Plus className="h-5 w-5" />
                            <span className="hidden lg:inline">Nueva Farmacia</span>
                        </Button>
                    </div>
                }
            />
