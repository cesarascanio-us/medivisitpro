...
export default function Samples() {
    const { user, isMaster, isAdmin, isManager, isSupervisor, isChief, isCoordinator, role, companyId, canViewSupervision } = useAuth();
    const { organization } = useOrganization();

    // Check if user can access supervisor features via RBAC
    const canAccessSupervisor = canViewSupervision || isSupervisor || isMaster;
