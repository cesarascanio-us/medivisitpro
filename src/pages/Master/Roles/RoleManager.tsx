    ...
    const seedDefaultPermissions = async () => {
        try {
            const newPerms = [
                ...
                { code: 'samples.view_supervision', name: 'Supervisión de Muestras', description: 'Permite acceder a la pestaña de Supervisión de Muestras y ver tableros de gestión', module: 'Samples' },
                { code: 'samples.manage_banks', name: 'Gestionar Bancos', description: 'Permite crear, asignar y auditar Bancos físicos de Muestras Médicas', module: 'Samples' },
                { code: 'samples.assign_stock', name: 'Asignar Stock', description: 'Permite transferir inventario de muestras a supervisores o fuerza de ventas', module: 'Samples' }
            ];
            ...
            for (const p of newPerms) {
                ...
                if (!data) {
                    ...
                    seeded = true;
                    // Auto-assign to Manager, Supervisor, Coordinator, etc
                    const rolesToAssign = ['manager', 'jefe', 'operaciones', 'supervisor', 'coordinator', 'master', 'admin'];
