...
export function WhatsAppSupport() {
    return (
        ...
        >
            ...
            <span className="absolute right-full mr-4 bg-card text-foreground px-4 py-2 rounded-lg text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl pointer-events-none">
