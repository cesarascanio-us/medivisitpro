...
export default function DashboardRouter() {
  ...
  if (['coordinador', 'coordinator', 'supervisor', 'finance', 'operations'].includes(role)) {
  ...
  // 6. Portal Médico y Jefes de Servicios Externos
  if (['medico', 'doctor', 'service_chief'].includes(role)) {
