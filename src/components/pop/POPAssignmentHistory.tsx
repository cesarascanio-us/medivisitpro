...
export function POPAssignmentHistory() {
        ...
        try {
            ...
            if (assignmentsData && assignmentsData.length > 0) {
                const userIds = [...new Set([
                    ...assignmentsData.map((a: any) => a.representative_id),
                    ...assignmentsData.map((a: any) => a.created_by)
                ].filter(Boolean))];
        ...
        <Card>
            <CardHeader>
                <CardTitle className="flex items-center gap-2">
                    ...
                    Historial de Asignaciones POP
                </CardTitle>
                <CardDescription>
                    Consulta todas las asignaciones de material POP realizadas.
                </CardDescription>
            </CardHeader>
            <CardContent>
                                            ...
                                            <TableRow key={`${a.id}-details`}>
                                                <TableCell colSpan={6} className="bg-muted/30 p-4">
                                                    <div className="text-sm font-medium mb-2 flex items-center gap-1">
                                                        <Package className="h-4 w-4" /> Materiales asignados:
                                                    </div>
