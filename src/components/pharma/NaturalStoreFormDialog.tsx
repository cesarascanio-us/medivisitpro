    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl p-0 overflow-hidden border-none shadow-3xl rounded-[2.5rem] bg-card font-outfit">
                ...
                <div className="px-10 py-8 space-y-10 max-h-[70vh] overflow-y-auto custom-scrollbar bg-background">
                ...
                <DialogFooter className="bg-muted/10 border-t border-border/40 px-10 py-8 flex items-center justify-between gap-6">
                    <Button
                        variant="ghost"
