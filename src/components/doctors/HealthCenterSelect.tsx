...
export function HealthCenterSelect({ value, fallbackName, onValueChange, className }: HealthCenterSelectProps) {
                        ...
                        <CommandGroup heading="Centros Disponibles">
                            ...
                            >
                                <div className="flex flex-col">
                                    <span className="font-bold text-slate-700">Ninguno (usar dirección manual)</span>
                                </div>
                                <Check
                                    className={cn(
