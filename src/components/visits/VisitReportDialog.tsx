          ...
          <div className="bg-gradient-medical p-6 rounded-lg text-primary-foreground">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-2xl font-bold">
                  {(visitData.unified_contacts || visitData.contacts)?.name || "Contacto no disponible"}
                </h2>
                <p className="text-primary-foreground/80">
                  {(visitData.unified_contacts || visitData.contacts)?.specialty || "Especialidad no especificada"}
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div className="flex items-center">
                ...
                {(visitData.unified_contacts || visitData.contacts)?.address || "Dirección no disponible"}
              </div>
            </div>
          </div>
